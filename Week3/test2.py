...
"Mubashir" ➞ "Hello, my Love!"
    """
str = "Narek"
greeting = ("Hello " + str + "!")*(str != "Mubashir") + \
    ("Hello " + str + ",my Love !")*(str == "Mubashir")
print(greeting)
...
a = 10
b = 9
result = "True"*(a == 10 or b == 10 or a+b == 10) + \
    "False"*(a != 10 and b != 10 and a+b != 10)
print(result)
...
"""
text, repeat = "barev", 3
print("Not A String !!"*(type(text) != str) +
      str(text*repeat)*(type(text) == str))
